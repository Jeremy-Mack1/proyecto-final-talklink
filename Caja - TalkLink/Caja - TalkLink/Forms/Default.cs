...
namespace Caja___TalkLink
{
    public partial class Default : Form
    {
        ...
        public Default()
        {
            ...
            this.BackColor = Color.FromArgb(0, 0, 139);
        }
        ...
        private void ActivateButton(object btnSender)
        {
            if (btnSender != null)
            {
                if(currentButton != (Button)btnSender)
                {
                    ...
                    currentButton.BackColor = Color.FromArgb(7, 0, 196);
        ...
        private void btn_Mazimizar_Click(object sender, EventArgs e)
        {
        ...
        private void OpenChildForm(Form childForm, object btnSender)
        {
            ...
            childForm.Show();
            lbl_TalkLinkTitle.Text = childForm.Text;
        ...
        {
            OpenChildForm(new AddClient(), sender);
