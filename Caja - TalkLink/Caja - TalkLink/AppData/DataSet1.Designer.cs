...
SELECT [ID Cliente], Nombre, Apellido, telefono, FechaRegistro, [Telefon Alt], Direccion, Estado FROM Clientes WHERE ([ID Cliente] = @ID_Cliente)";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Clientes] SET [ID Cliente] = @ID_Cliente, [Nombre] = @Nombre, [Apellido] = @Apellido, [telefono] = @telefono, [FechaRegistro] = @FechaRegistro, [Telefon Alt] = @Telefon_Alt, [Direccion] = @Direccion, [Estado] = @Estado WHERE (([ID Cliente] = @Original_ID_Cliente) AND ((@IsNull_Nombre = 1 AND [Nombre] IS NULL) OR ([Nombre] = @Original_Nombre)) AND ((@IsNull_Apellido = 1 AND [Apellido] IS NULL) OR ([Apellido] = @Original_Apellido)) AND ((@IsNull_telefono = 1 AND [telefono] IS NULL) OR ([telefono] = @Original_telefono)) AND ((@IsNull_FechaRegistro = 1 AND [FechaRegistro] IS NULL) OR ([FechaRegistro] = @Original_FechaRegistro)) AND ((@IsNull_Telefon_Alt = 1 AND [Telefon Alt] IS NULL) OR ([Telefon Alt] = @Original_Telefon_Alt)) AND ((@IsNull_Direccion = 1 AND [Direccion] IS NULL) OR ([Direccion] = @Original_Direccion)) AND ((@IsNull_Estado = 1 AND [Estado] IS NULL) OR ([Estado] = @Original_Estado)));
SELECT [ID Cliente], Nombre, Apellido, telefono, FechaRegistro, [Telefon Alt], Direccion, Estado FROM Clientes WHERE ([ID Cliente] = @ID_Cliente)";
        ...
        public virtual int Delete(int Original_ID_Cliente, string Original_Nombre, string Original_Apellido, string Original_telefono, global::System.Nullable<global::System.DateTime> Original_FechaRegistro, string Original_Telefon_Alt, string Original_Direccion, string Original_Estado) {
            ...
            if ((Original_Telefon_Alt == null)) {
                ...
                this.Adapter.DeleteCommand.Parameters[10].Value = ((string)(Original_Telefon_Alt));
            }
        ...
        public virtual int Insert(int ID_Cliente, string Nombre, string Apellido, string telefono, global::System.Nullable<global::System.DateTime> FechaRegistro, string Telefon_Alt, string Direccion, string Estado) {
        ...
        public virtual int Update(
            ...
            if ((Original_Telefon_Alt == null)) {
                ...
                this.Adapter.UpdateCommand.Parameters[18].Value = ((string)(Original_Telefon_Alt));
            }
            if ((Original_Direccion == null)) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string Nombre, string Apellido, string telefono, global::System.Nullable<global::System.DateTime> FechaRegistro, string Telefon_Alt, string Direccion, string Estado, int Original_ID_Cliente, string Original_Nombre, string Original_Apellido, string Original_telefono, global::System.Nullable<global::System.DateTime> Original_FechaRegistro, string Original_Telefon_Alt, string Original_Direccion, string Original_Estado) {
