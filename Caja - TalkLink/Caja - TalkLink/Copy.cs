...
namespace Caja___TalkLink
{
    internal class Copy
    {
        ...
        ciudadDeserializado.CiudadNombre = jsonstring.CiudadNombre;
        ciudadDeserializado.Cod_Postal = jsonstring.Cod_Postal;

        Ciudad ciudadSerializado = new Ciudad();
        ciudadSerializado.ID_Ciudad = 11;
        ciudadSerializado.CiudadNombre = "Moca";
